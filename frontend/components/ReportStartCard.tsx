      ...
      <div className="relative">
        ...
        <div className="p-6 space-y-4">
          ...
          <div className="space-y-3">
            ...
            {(report?.booking_details?.checkin_date || report?.booking_details?.checkout_date) && (
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="space-y-1 flex flex-row gap-4">
                    {(report?.booking_details?.checkin_date) && (
                      <p className="text-sm text-gray-600">
                        <span
                          className="font-medium">Заезд:</span> {new Date(report?.booking_details?.checkin_date).toLocaleDateString('ru-RU')}
                      </p>
                    )}
                    {(report?.booking_details?.checkout_date) && (
                      <p className="text-sm text-gray-600">
                        <span
                          className="font-medium">Выезд:</span> {new Date(report?.booking_details?.checkout_date).toLocaleDateString('ru-RU')}
                      </p>
                    )}
                  </div>
                </div>
          ...
          <div className="pt-2">
            ...
            {onBackToFAQ && (
              <div className="text-center mt-4">
                <button
                  onClick={onBackToFAQ}
                  className="text-sm text-gray-500 hover:text-gray-700 underline transition-colors duration-200 cursor-pointer"
                >
                  Назад к FAQ
                </button>
              </div>

...
function ContinueAssignmentsContent() {
  ...
  // Только те, у которых отчет в статусе draft (2) - уже начатые
  const acceptedAssignments = assignments.filter(assignment => {
    ...
    console.log(`Assignment ${assignment.id} report status:`, {
    ...
    // Показываем только если отчет в статусе draft (2) - уже начатый
    ...
    <div className="min-h-screen bg-accentgreen">
      ...
      <main className="min-h-screen">
        <div className="max-w-md mx-auto px-6 py-8">
          ...
          {(() => {
            const shouldShow = !assignmentsLoading && acceptedAssignments.length > 0;
          ...
          {/* No Continue Assignments Message */}
          {!assignmentsLoading && acceptedAssignments.length === 0 && (
            <div className="text-center py-12">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">
                Нет заданий для продолжения
              </h3>
              <p className="text-gray-600 mb-6">
                У вас нет заданий в процессе заполнения
              </p>
              <Button
...
export default function ContinueAssignments() {
  return (
    <Suspense fallback={
      <div className="min-h-screen flex items-center justify-center bg-accentgreen">
        <div className="text-center">
